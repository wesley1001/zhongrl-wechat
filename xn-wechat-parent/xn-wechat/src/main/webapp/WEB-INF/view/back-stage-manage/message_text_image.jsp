                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                          		<div class="span12 field-box">
		                            ...
		                            <div class="ui-select span5" style="width: 300px;">
		                                 <select id="wechat_name" style="width: 300px;">
		                                     <option value="QGZ" selected="selected">钱罐子</option>
		                                     <option value="XNQGZ" >小牛钱罐子</option>
		                                 </select>
		                              </div>
		                           </div>
		                           <div class="span12 field-box">
		                            <label>消息类型:</label>
		                            <div class="ui-select span5" style="width: 300px;">
		                                 <select id="message_type" style="width: 300px;">
		                         ...
		                         <div class="span12 field-box">
                                    ...
                                    <input class="span8" type="text" id="channel" name="channel"/>
        ...
        $(function () {
            ...
            $("#saveConfig").click(function(){
				...
				$.ajax({
           			...
           			dataType : 'json',
           			async: false,
           			url : '${path}wechat/saveReplyMessage.do',
           			data : param,
