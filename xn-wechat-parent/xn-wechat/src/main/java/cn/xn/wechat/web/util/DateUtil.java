...
public class DateUtil {
    ...
    * @throws 
    */
    public static String getYesterDay(DateStyle dateStype){
    	SimpleDateFormat format = getDateFormat(dateStype.getValue());
         try{
    ...
    public static String toTimeStampFm(Date date) {
